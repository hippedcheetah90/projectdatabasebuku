...
<form method="post" action="buku_edit_proses.php">
  	...
  	<div class="form-group row">
    	<label for="tahun" class="col-sm-2 col-form-label">Tahun Terbit</label>
   		<div class="col-sm-10">
     		<input type="text" class="form-control" id="tahun" name="tahun" value="<?php echo $row->tahun_terbit; ?>">
    	</div>
  	</div>
  	<div class="form-group row">
  	...
  	<div class="form-group row">
    	<label for="deskripsi" class="col-sm-2 col-form-label">Deskripsi</label>
   		<div class="col-sm-10">
   			<textarea class="form" id="deskripsi" name="deskripsi" value="<?php echo $row->deskripsi; ?>"></textarea>
    	</div>
  	</div>
  	<div class="form-group row">
